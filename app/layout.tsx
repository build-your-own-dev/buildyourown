...
import { DesktopNav, LiquidGlassRuntime, MobileNav, PageRevealRuntime } from "./ui";
import "./globals.css";
...
export default function Layout({children}:{children:React.ReactNode}){return <html lang="de"><body>
<LiquidGlassRuntime/>
<PageRevealRuntime/>
