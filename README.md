...
- Kategorien für Speisen, Getränke und mehr erstellen und inklusive ihrer Einträge löschen
- Bestehende Speisekarten aus bis zu fünf Bildern automatisch erkennen und vor dem Import bearbeiten
...
Die Speisekartenerkennung läuft mit Tesseract.js vollständig lokal im Browser.
Ausgewählte Bilder werden weder in Supabase gespeichert noch an einen anderen
Server gesendet und nach Abschluss der Analyse aus dem Arbeitsspeicher der App
entfernt. Nur die vom Nutzer geprüften Menütexte werden beim Import gespeichert.
